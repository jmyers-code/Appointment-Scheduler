...
namespace AppointmentManagementSystem.Controllers.Api
{
    ...
    public class AppointmentApiController : ControllerBase
    {
        ...
        public IActionResult GetCalendarData(string nurseId)
        {
            ...
            try
            {
                ...
                else if (role == Helper.Nurse)
                {
                    commonResponse.dataenum = _appointmentService.NursesEventById(loginUserId);
                    commonResponse.status = Helper.success_code;
                }
                else
                {
                    commonResponse.dataenum = _appointmentService.NursesEventById(nurseId);
                    commonResponse.status = Helper.success_code;
                }
            }
            catch (Exception e)
